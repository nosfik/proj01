...
class ControllerInformationNews extends Controller {
	...
	public function index() {
		...
		foreach ($all_news as $news) {
			$this->data['all_news'][] = array (
				'title' => $news['title'],
				'description' => (strlen(strip_tags(html_entity_decode($news['description']))) > 1000 ? substr(strip_tags(html_entity_decode($news['description'])), 0, 1000) . '...' : strip_tags(html_entity_decode($news['description']))),
