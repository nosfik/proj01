...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		$this->document->addScript('catalog/view/javascript/jquery.ad-gallery.js');
        $this->document->addStyle('catalog/view/theme/default/stylesheet/jquery.ad-gallery.css');
		...
		if ($product_info) {
			...
			if ($product_info['image']) {
				$this->data['popup'] = $this->model_tool_image->resize($product_info['image'], 610, 444, 2);
			} else {
				$this->data['popup'] = '';
			}
			
			if ($product_info['image']) {
				$this->data['thumb'] = $this->model_tool_image->resize($product_info['image'], 181, 130, 1);
			} else {
				$this->data['thumb'] = '';
			}
