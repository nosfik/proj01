...
<div id="yellow_cont">
        ...
        <div id="edit_photo_cont">
          ...
          <div id="photo_cont">
            ...
            <img src="<?php echo $photo['path']?>"><a class="left" href="#">Предыдущее фото</a><a class="right" href="#">Следующее фото</a></div>
          <div id="white">
            <div class="left">
...
<div id="green_cont">
      <div style="float:right"><div onmouseout="$(this).removeClass('hover');" onmouseover="$(this).addClass('hover');" class="bigButton" style="float:right"><a href="#" class="left">Применить к фото</a>
          <div class="right"></div>
        </div>
        <div class="clear"></div>
        <div onmouseout="$(this).removeClass('hover');" onmouseover="$(this).addClass('hover');" class="bigButton" style="float:right"><a href="#" class="left">Применить к копии</a>
          <div class="right"></div>
        </div>
        <div class="clear"></div>
        <div onmouseout="$(this).removeClass('hover');" onmouseover="$(this).addClass('hover');" class="bigButton" style="float:right"><a href="#" class="left">Вернуться к заказу</a>
          <div class="right"></div>
        </div></div>
        <div id="edit_photo_buttons">
          <div class="linkCont"><a href="#" class="b1">Кадрировать</a></div>
