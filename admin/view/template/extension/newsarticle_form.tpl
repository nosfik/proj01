          ...
          <div id="tab-language-<?php echo $language['language_id']; ?>">
			<table class="form">
				<tr>
					...
					<td><input type="text" name="newsarticle[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($newsarticle[$language['language_id']]) ? $newsarticle[$language['language_id']]['title'] : ''; ?>" /></td>
				</tr>
				<tr>
					<td><?php echo $text_description; ?></td>
					<td><textarea name="newsarticle[<?php echo $language['language_id']; ?>][description]" id="description-<?php echo $language['language_id']; ?>"><?php echo isset($newsarticle[$language['language_id']]) ? $newsarticle[$language['language_id']]['description'] : ''; ?></textarea></td>
				</tr>
			</table>
		  </div>
		<?php } ?>
