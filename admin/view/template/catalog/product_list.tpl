          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'p.number') { ?>
                <a href="<?php echo $sort_number; ?>" class="<?php echo strtolower($order); ?>">[НОМЕР]</a>
                <?php } else { ?>
                <a href="<?php echo $sort_number; ?>">[НОМЕР]</a>
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'p.city') { ?>
                <a href="<?php echo $sort_number; ?>" class="<?php echo strtolower($order); ?>">[ГОРОД]</a>
                <?php } else { ?>
                <a href="<?php echo $sort_number; ?>">[ГОРОД]</a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $product['number']; ?></td>
               <td class="left"><?php echo $product['city']; ?></td>
