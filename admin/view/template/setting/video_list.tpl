...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/shipping.png" alt="" />Слайдер на главной</h1>
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'href') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">Код</a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>">Код</a>
                <?php } ?></td>
              <td class="right"><?php if ($sort == 'order') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($video['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $video['href']; ?></td>
              <td class="right"><?php echo $video['order']; ?></td>
