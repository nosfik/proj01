...
$_['text_approve_welcome']      = 'Добро пожаловать и благодарим Вас за регистрацию на нашем сайте!';
$_['text_approve_login']        = 'Ваш аккаунт создан и Вы можете войти используя Ваши E-mail и пароль, посетив наш сайт по адресу:';
$_['text_approve_services']     = 'После регистрации Вы сможете воспользоваться дополнительными возможностями: создавать альбомы, отправлять фото в печать, делать покупкив в ИМ, просматривать историю заказов, изменять информацию Вашей учетной записи и др.';
